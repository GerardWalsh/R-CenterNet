...
class PascalVOC2coco(object):
    ...
    def getsegmentation(self):
        ...
        try:
            ...
            mask[rectangle[1] : rectangle[3], rectangle[0] : rectangle[2]] = mask_1[
...
xml_file = glob.glob(
    "/home/gerwal/train/R-CenterNet/data/defect/annotations_val_small_set/*.xml"
)
# print("All xmls", xml_file)
# xml_file=['./Annotations/000032.xml']
# xml_file=['00000007_05499_d_0000037.xml']
PascalVOC2coco(
    xml_file, "/home/gerwal/train/R-CenterNet/data/defect/annotations/val.json"
)
